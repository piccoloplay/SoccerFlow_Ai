...
public class GameManager : MonoBehaviourPunCallbacks
{
    ...
    public Vector3[] playerBallSpawnPositions = new Vector3[]
    {
    ...
    public float mischiaBallScale = 2f;
    ...
    public float goalkeeperBallScale = 1.25f;
    ...
    public int endGameReturnSeconds = 15;
