...
public class MainMenuBuilder : MonoBehaviour
{
    ...
    public Color panelColor   = new Color(0.14f, 0.14f, 0.20f);
    public Color accentColor  = new Color(0.15f, 0.45f, 0.90f);
    public Color dangerColor  = new Color(0.85f, 0.20f, 0.20f);
