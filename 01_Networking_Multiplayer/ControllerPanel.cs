...
public class ControllerPanel : MonoBehaviour
{
    ...
    [Header("─── Colori ─────────────────────────────────────")]
    [SerializeField] private Color activeColor   = new Color(0.15f, 0.37f, 0.78f);
    [SerializeField] private Color disabledColor = new Color(0.30f, 0.30f, 0.30f);
    [SerializeField] private Color emptyColor    = new Color(0.20f, 0.20f, 0.20f);
    [SerializeField] private Color correctColor  = new Color(0.10f, 0.72f, 0.25f);
    [SerializeField] private Color wrongColor    = new Color(0.85f, 0.15f, 0.15f);
    [SerializeField] private Color savedColor    = new Color(0.95f, 0.75f, 0.10f);  // giallo = scelto + parato
