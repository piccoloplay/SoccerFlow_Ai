...
{
    [Header("─── COLORI ────────────────────────────────────")]
    public Color fieldColor       = new Color(0.18f, 0.48f, 0.18f);
    public Color lineColor        = Color.white;
    public Color goalColor        = Color.white;
    public Color panelColor       = new Color(0.15f, 0.37f, 0.78f);
    ...
    public Color goalkeeperColor  = new Color(0.95f, 0.85f, 0.10f);
    public Color ballColor        = Color.white;

    [Header("─── OUTPUT ───────────────────────────────────")]
    [Tooltip("Path completo del prefab da salvare. La cartella viene creata se non esiste.")]
    public string prefabSavePath  = "Assets/Prefabs/GameField.prefab";
    ...
    public string materialsFolder = "Assets/Prefabs/Materials";
    ...
    public bool goalkeeperDisabledByDefault = true;
