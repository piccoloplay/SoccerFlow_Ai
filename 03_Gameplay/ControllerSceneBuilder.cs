...
{
    [Header("─── Colori ────────────────────────────────────")]
    public Color bgColor        = new Color(0.10f, 0.10f, 0.14f);
    public Color panelActive    = new Color(0.15f, 0.37f, 0.78f);
    public Color panelDisabled  = new Color(0.22f, 0.22f, 0.28f);
    public Color panelEmpty     = new Color(0.14f, 0.14f, 0.18f);
    public Color accentColor    = new Color(0.95f, 0.85f, 0.10f);
