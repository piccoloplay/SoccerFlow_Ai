...
public class BallController : MonoBehaviour
{
    ...
    [SerializeField] private bool flatTrajectory = true;
    ...
    [SerializeField] private bool useBouncyMaterial = true;
    [Range(0f, 1f)] [SerializeField] private float bounciness = 0.8f;
