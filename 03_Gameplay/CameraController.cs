...
public class CameraController : MonoBehaviour
{
    ...
    public Vector3 overviewPosition = new Vector3(0f, 6f, -8f);
    public Vector3 overviewEuler    = new Vector3(28f, 0f, 0f);
