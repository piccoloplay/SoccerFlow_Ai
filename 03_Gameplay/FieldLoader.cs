...
public class FieldLoader : MonoBehaviour
{
    ...
    [SerializeField] private GameObject gameFieldPrefabAI;

    [Header("─── Camera Setup ─────────────────────────────")]
    [Tooltip("Configura la Main Camera con la visuale overview del campo")]
    [SerializeField] private bool   setupCamera     = true;
    [SerializeField] private Vector3 cameraPosition = new Vector3(0f, 6f, -8f);
    [SerializeField] private Vector3 cameraEuler    = new Vector3(28f, 0f, 0f);
    [SerializeField] private Color   skyColor       = new Color(0.53f, 0.81f, 0.98f);

    [Header("─── Goalkeeper ───────────────────────────────")]
    [Tooltip("Forza l'attivazione del portiere ignorando la Room Property (test offline)")]
    [SerializeField] private bool forceGoalkeeper = false;

    [Header("─── Wiring ──────────────────────────────────")]
    [Tooltip("Disabilita GameSceneAutoWire (se presente) per evitare doppio wiring conflittuale")]
    [SerializeField] private bool disableAutoWire = true;
