...
public class AnswerPanel : MonoBehaviour
{
    ...
    [Header("─── Colori ─────────────────────────────────────")]
    [SerializeField] private Color defaultColor  = new Color(0.15f, 0.37f, 0.78f);
    ...
    [SerializeField] private Color savedColor    = new Color(0.95f, 0.75f, 0.10f);  // giallo = pannello scelto ma parato
