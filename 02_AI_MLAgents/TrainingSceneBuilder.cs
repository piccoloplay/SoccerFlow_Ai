...
public class TrainingSceneBuilder : MonoBehaviour
{
    ...
    [Range(1, 8)]
    [SerializeField] private int arenaCount = 1;
    [SerializeField] private float arenaSpacing = 14f;
    ...
    [SerializeField] private bool disableInGameGoalkeeperScript = true;
    [Tooltip("Disabilita BallController.cs (animazione kinematic). L'Agent userà fisica reale.")]
    [SerializeField] private bool disableInGameBallController = true;
    ...
    [SerializeField] private Color skyColor = new Color(0.55f, 0.65f, 0.75f);
